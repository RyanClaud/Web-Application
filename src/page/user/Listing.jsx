  ...
  return (
    <div className="w-full py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900 tracking-tight">Browse Our Inventory</h1>

        <div className="max-w-2xl mx-auto mb-12">
          <input
            type="text"
            placeholder="Search by make or model..."
            className="w-full p-4 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            value={search}
            ...
            {totalPages > 1 && (
              <nav className="flex flex-wrap justify-center items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-white text-gray-700 border border-gray-300 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Prev
                </button>
